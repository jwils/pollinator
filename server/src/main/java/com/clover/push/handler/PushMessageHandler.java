package com.clover.push.handler;

import com.clover.push.client.DefaultPushClient;
import com.clover.push.client.NettyPushConnection;
...
public class PushMessageHandler extends ChannelDuplexHandler {
  ...
  public void handleRegister(ChannelHandlerContext ctx, ConnectMessage msg) {
      ...
      client = new DefaultPushClient(msg.getClientId(), pushMessageSubscriber);
